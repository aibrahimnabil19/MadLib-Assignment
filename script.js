...
console.log(`${yourName} broke up with his ex (${exName}) after discovering that every night, ${exName} would ${verb} while asleep and narrate her dreams like a ${occupation}. One night she shouted "${mansName}!" and pretended to score a ${sport} goal. ${yourName} realized love should not come with another man's name and sport commentary so he broke up with her.`);
